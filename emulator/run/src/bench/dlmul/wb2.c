...
static __attribute__((noinline)) size_t wb2_phase1_step(int offset, size_t avl) {
    ...
    vint16m1_t act = __riscv_vle16_v_i16m1(&wb2_activation[offset], vl);
    vint16m1_t wt = __riscv_vle16_v_i16m1(&wb2_weight[offset], vl);
    vint32m2_t widened = __riscv_vwadd_vv_i32m2(act, wt, vl);
    __riscv_vse32_v_i32m2(&wb2_partial[offset], widened, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb2_phase1_step(int offset, size_t avl) {
    ...
    __riscv_vse32_v_i32m4(&wb2_partial[offset], widened, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb2_phase2_step(int offset, size_t avl) {
    ...
    vint16m1_t act = __riscv_vle16_v_i16m1(&wb2_activation[offset], vl);
    vint16m1_t wt = __riscv_vle16_v_i16m1(&wb2_weight[offset], vl);
    vint16m1_t bias = __riscv_vle16_v_i16m1(&wb2_bias16[offset], vl);
    vint32m2_t partial = __riscv_vle32_v_i32m2(&wb2_partial[offset], vl);
    vint32m2_t acc0 = __riscv_vwmul_vv_i32m2(act, wt, vl);
    vint32m2_t acc1 = __riscv_vwmul_vv_i32m2(act, bias, vl);
    vint32m2_t acc2 = __riscv_vwmul_vv_i32m2(wt, bias, vl);
    ...
    __riscv_vse32_v_i32m2(&wb2_output[offset], out, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb2_phase2_step(int offset, size_t avl) {
    ...
    vint32m4_t acc2 = __riscv_vwmul_vv_i32m4(wt, bias, vl);
    ...
    __riscv_vse32_v_i32m4(&wb2_output[offset], out, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb2_phase3_step(int offset, size_t avl) {
    ...
    vint32m1_t out = __riscv_vle32_v_i32m1(&wb2_output[offset], vl);
    vint32m1_t partial = __riscv_vle32_v_i32m1(&wb2_partial[offset], vl);
...
static __attribute__((noinline)) size_t wb2_phase3_step(int offset, size_t avl) {
    ...
    vint32m2_t out = __riscv_vle32_v_i32m2(&wb2_output[offset], vl);
    vint32m2_t partial = __riscv_vle32_v_i32m2(&wb2_partial[offset], vl);
