...
void kernel(void) {
    ...
    for (int iter = 0; iter < 24; ++iter) {
        for (int offset = 0; offset < 192; offset += (int)vl4) {
            ...
            vint16m4_t x_big = __riscv_vle16_v_i16m4(&wb6_src0[offset], avl);
            vint16m4_t y_big = __riscv_vle16_v_i16m4(&wb6_src1[offset], avl);
            vint16m4_t z_big = __riscv_vle16_v_i16m4(&wb6_src2[offset], avl);
