...
static __attribute__((noinline)) size_t wb7_phase1_step(int offset, size_t avl) {
    ...
    vint16m1_t x = __riscv_vle16_v_i16m1(&wb7_src0[offset], vl);
    vint16m1_t y = __riscv_vle16_v_i16m1(&wb7_src1[offset], vl);
    vint32m2_t base = __riscv_vwadd_vv_i32m2(x, y, vl);
    __riscv_vse32_v_i32m2(&wb7_base[offset], base, vl);
    return vl;
}
#elif DLB_PHASE1_VARIANT == DLMUL_LMUL_M2
static __attribute__((noinline)) size_t wb7_phase1_step(int offset, size_t avl) {
    size_t vl = __riscv_vsetvl_e16m2(avl);
    vint16m2_t x = __riscv_vle16_v_i16m2(&wb7_src0[offset], vl);
    vint16m2_t y = __riscv_vle16_v_i16m2(&wb7_src1[offset], vl);
    vint32m4_t base = __riscv_vwadd_vv_i32m4(x, y, vl);
    __riscv_vse32_v_i32m4(&wb7_base[offset], base, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb7_phase2_step(int offset, size_t avl) {
    ...
    vint16m1_t x = __riscv_vle16_v_i16m1(&wb7_src0[offset], vl);
    vint16m1_t y = __riscv_vle16_v_i16m1(&wb7_src1[offset], vl);
    vint16m1_t z = __riscv_vle16_v_i16m1(&wb7_src2[offset], vl);
    vint32m2_t base = __riscv_vle32_v_i32m2(&wb7_base[offset], vl);
    vint32m2_t sq = __riscv_vwmul_vv_i32m2(x, x, vl);
    vint32m2_t cross = __riscv_vwmul_vv_i32m2(y, z, vl);
    vint32m2_t mix = __riscv_vwmul_vv_i32m2(x, z, vl);
    vint32m2_t out = __riscv_vadd_vv_i32m2(base, sq, vl);
    out = __riscv_vadd_vv_i32m2(out, cross, vl);
    out = __riscv_vsub_vv_i32m2(out, mix, vl);
    __riscv_vse32_v_i32m2(&wb7_poly[offset], out, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb7_phase2_step(int offset, size_t avl) {
    ...
    vint16m2_t x = __riscv_vle16_v_i16m2(&wb7_src0[offset], vl);
    vint16m2_t y = __riscv_vle16_v_i16m2(&wb7_src1[offset], vl);
    vint16m2_t z = __riscv_vle16_v_i16m2(&wb7_src2[offset], vl);
    vint32m4_t base = __riscv_vle32_v_i32m4(&wb7_base[offset], vl);
    vint32m4_t sq = __riscv_vwmul_vv_i32m4(x, x, vl);
    vint32m4_t cross = __riscv_vwmul_vv_i32m4(y, z, vl);
    vint32m4_t mix = __riscv_vwmul_vv_i32m4(x, z, vl);
    vint32m4_t out = __riscv_vadd_vv_i32m4(base, sq, vl);
    out = __riscv_vadd_vv_i32m4(out, cross, vl);
    out = __riscv_vsub_vv_i32m4(out, mix, vl);
    __riscv_vse32_v_i32m4(&wb7_poly[offset], out, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb7_phase3_step(int offset, size_t avl) {
    ...
    vint32m1_t base = __riscv_vle32_v_i32m1(&wb7_base[offset], vl);
    vint32m1_t poly = __riscv_vle32_v_i32m1(&wb7_poly[offset], vl);
    vint32m1_t out = __riscv_vadd_vv_i32m1(base, poly, vl);
...
static __attribute__((noinline)) size_t wb7_phase3_step(int offset, size_t avl) {
    ...
    vint32m2_t base = __riscv_vle32_v_i32m2(&wb7_base[offset], vl);
    vint32m2_t poly = __riscv_vle32_v_i32m2(&wb7_poly[offset], vl);
    vint32m2_t out = __riscv_vadd_vv_i32m2(base, poly, vl);
