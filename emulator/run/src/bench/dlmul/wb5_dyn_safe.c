        ...
        for (int offset = 0; offset < 128; offset += (int)vl4) {
...

            {
                ...
                if (start < avl) {
                    ...
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwadd_vv_i32m2(x, y, vlc), vlc);
                    ...
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(y, z, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwadd_vv_i32m2(x, z, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(x, z, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwadd_vv_i32m2(x, x, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwadd_vv_i32m2(y, y, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(z, z, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(y, x, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwadd_vv_i32m2(z, x, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(z, y, vlc), vlc);
