...
static __attribute__((noinline)) size_t wb8_phase1_step(int offset, size_t avl) {
    ...
    __riscv_vse32_v_i32m2(&wb8_seed[offset], seed, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb8_phase1_step(int offset, size_t avl) {
    ...
    __riscv_vse32_v_i32m4(&wb8_seed[offset], seed, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb8_phase2_step(int offset, size_t avl) {
    ...
    vint32m2_t seed = __riscv_vle32_v_i32m2(&wb8_seed[offset], vl);
    vint32m2_t left = __riscv_vadd_vv_i32m2(seed, __riscv_vwmul_vv_i32m2(x, y, vl), vl);
    vint32m2_t right = __riscv_vadd_vv_i32m2(seed, __riscv_vwmul_vv_i32m2(x, z, vl), vl);
    left = __riscv_vadd_vv_i32m2(left, __riscv_vwadd_vv_i32m2(y, z, vl), vl);
    right = __riscv_vadd_vv_i32m2(right, __riscv_vwmul_vv_i32m2(y, y, vl), vl);
    __riscv_vse32_v_i32m2(&wb8_left[offset], left, vl);
    __riscv_vse32_v_i32m2(&wb8_right[offset], right, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb8_phase2_step(int offset, size_t avl) {
    ...
    vint32m4_t seed = __riscv_vle32_v_i32m4(&wb8_seed[offset], vl);
    vint32m4_t left = __riscv_vadd_vv_i32m4(seed, __riscv_vwmul_vv_i32m4(x, y, vl), vl);
    vint32m4_t right = __riscv_vadd_vv_i32m4(seed, __riscv_vwmul_vv_i32m4(x, z, vl), vl);
    left = __riscv_vadd_vv_i32m4(left, __riscv_vwadd_vv_i32m4(y, z, vl), vl);
    right = __riscv_vadd_vv_i32m4(right, __riscv_vwmul_vv_i32m4(y, y, vl), vl);
    __riscv_vse32_v_i32m4(&wb8_left[offset], left, vl);
    __riscv_vse32_v_i32m4(&wb8_right[offset], right, vl);
    return vl;
}
...
static __attribute__((noinline)) size_t wb8_phase3_step(int offset, size_t avl) {
    ...
    vint32m1_t left = __riscv_vle32_v_i32m1(&wb8_left[offset], vl);
    vint32m1_t right = __riscv_vle32_v_i32m1(&wb8_right[offset], vl);
    vint32m1_t out = __riscv_vadd_vv_i32m1(left, right, vl);
...
static __attribute__((noinline)) size_t wb8_phase3_step(int offset, size_t avl) {
    ...
    vint32m2_t left = __riscv_vle32_v_i32m2(&wb8_left[offset], vl);
    vint32m2_t right = __riscv_vle32_v_i32m2(&wb8_right[offset], vl);
    vint32m2_t out = __riscv_vadd_vv_i32m2(left, right, vl);
