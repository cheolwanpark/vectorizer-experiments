...
void kernel(void) {
    ...
    for (int iter = 0; iter < 24; ++iter) {
        ...
        while (remaining > 0) {
            ...
            vint32m8_t partial = __riscv_vwadd_vv_i32m8(act, wt, vl);
            vint32m8_t out = __riscv_vadd_vv_i32m8(partial, partial, vl);
            out = __riscv_vadd_vv_i32m8(out, __riscv_vwmul_vv_i32m8(act, wt, vl), vl);
            out = __riscv_vadd_vv_i32m8(out, __riscv_vwmul_vv_i32m8(act, bias, vl), vl);
            out = __riscv_vadd_vv_i32m8(out, __riscv_vwmul_vv_i32m8(wt, bias, vl), vl);
