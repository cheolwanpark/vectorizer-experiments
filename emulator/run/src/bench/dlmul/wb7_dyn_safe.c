        ...
        for (int offset = 0; offset < 192; offset += (int)vl4) {
...

            {
                ...
                if (start < avl) {
                    ...
                    vint32m2_t out = __riscv_vadd_vv_i32m2(base, base, vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(x, x, vlc), vlc);
                    out = __riscv_vadd_vv_i32m2(out, __riscv_vwmul_vv_i32m2(y, z, vlc), vlc);
                    out = __riscv_vsub_vv_i32m2(out, __riscv_vwmul_vv_i32m2(x, z, vlc), vlc);
